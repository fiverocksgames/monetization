...
For a game-developer-facing, read-only-researched React/Vite porting example, see
[`docs/guides/MATCH_FIX_H5_MONETIZATION_PORTING.md`](../../../docs/guides/MATCH_FIX_H5_MONETIZATION_PORTING.md).
This is a developer guide, not an npm SDK release or production ads authorization.
