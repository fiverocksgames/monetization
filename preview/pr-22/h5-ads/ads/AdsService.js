...
export class AdsService {
  constructor({ environment = 'development', publisherId = '', mockRoot, manifestUrl, fallbackAds = [], mockClickUrl = '', log = () => {}, onStatus = () => {} } = {}) {
    ...
    this.mock = environment === 'development'
      ? new MockAdsProvider({ root: mockRoot, manifestUrl, fallbackAds, clickUrlOverride: mockClickUrl, log })
      : null;
